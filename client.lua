...
function missionstart()
	...
	starting = true
	animals = {
	{hash = 0xF0F6D94, x = -2044.69, y = -488.16, z = 150.0, true, true},
	{hash = 0xF0F6D94, x = -2047.01, y = -493.41, z = 149.69, true, true},
	{hash = 0xF0F6D94, x = -1821.81, y = -818.22, z = 106.22, true, true},
	{hash = 0xF0F6D94, x = -1657.83, y = -681.25, z = 148.64, true, true}
			  }
...
Citizen.CreateThread(function()
    while true do
		...
		local betweencoords = GetDistanceBetweenCoords(coords, -1791.3, -387.11, 160.33, true)
		if betweencoords < 2.0 and not already then
			DrawTxt(Config.HuntingMessage, 0.50, 0.90, 0.7, 0.7, true, 255, 255, 255, 255, true)
			if IsControlJustPressed(2, 0x4AF4D473) and not pressing then
				pressing = true
